public class InkrementDekrement {
	...
	/*
	 * Diese Methode soll die Zahl zahl um 1 dekrementieren, das heisst um 1
	 * erniedrigen, und zurueckgeben.
	 */
	public static int dekrementiere(int zahl) {
		return --zahl;// zu bearbeiten
	}

	// Die main Methode zum Testen der Methoden. Du kannst auch eigene Testfaelle
	// testen.
