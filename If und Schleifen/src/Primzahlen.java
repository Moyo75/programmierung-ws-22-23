public class Primzahlen {
	 ...
	 * Eine Zahl ist genau dann eine Primzahl, wenn sie durch genau 2 Zahlen teilbar
	 * ist, naemlich 1 und diese Zahl. Anders formuliert koennte man auch sagen:
	 * Eine Zahl ist genau dann eine Primzahl, wenn keine Zahl i existiert, fuer die
	 * gilt: i>=2 und i < zahl und zahl%i == 0 Sollte die uebergebene Zahl eine
	 * Primzahl sein, soll true zureuckgegeben werden, sonst false.
	 */
