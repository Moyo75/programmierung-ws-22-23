public class PythagoreischesTripel {
	...
	/*
	 * Diese Methode soll zurueckgeben, ob es sich bei den drei Zahlen a, b und c um
	 * ein pythagoreisches Tripel handelt. Drei Zahlen a, b und c sind genau dann
	 * ein pythagoreisches Tripel, wenn gilt: a*a+b*b=c*c Beispiele:
	 * tripel(3,4,5)--> true tripel(20,21,29)--> true tripel(1,2,3)--> false
	 */
